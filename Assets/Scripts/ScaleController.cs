...
public class ScaleController : MonoBehaviour
{
    ...
    // // TODO: the following function has a lot in common with the above
    // // consider parameterizing something and combining into one function
    // void AreaUpdate()
    // {
    //     Debug.Log("here");
    //     Vector3 scale = m_RectTransform.localScale;
    //     if (m_Parent.transform.parent.localScale.x != 0)
    //     {
    //         scale.x = m_BaseScale.x / m_Parent.transform.parent.localScale.x;
    //     }
    //     else
    //     {
    //         scale.x = 0;
    ...
    //     scale.y = m_BaseScale.y / m_Parent.transform.parent.localScale.y; // TODO: these could be moved out of update

    //     m_RectTransform.localScale = scale;

    //     Vector3 size = m_RectTransform.sizeDelta;
    //     size.x = m_BaseWidthHeight.x * m_Parent.transform.parent.localScale.x;

    //     size.y = m_BaseWidthHeight.y * m_Parent.transform.parent.localScale.y; // TODO: these could be moved out of update
