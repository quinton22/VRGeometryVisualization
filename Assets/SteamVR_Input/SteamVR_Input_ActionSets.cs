...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_penActions p_penActions;
        ...
        public static SteamVR_Input_ActionSet_penActions penActions
        {
            get
            {
                return SteamVR_Actions.p_penActions.GetCopy<SteamVR_Input_ActionSet_penActions>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_penActions = ((SteamVR_Input_ActionSet_penActions)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_penActions>("/actions/penActions")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.penActions};
        }
    }
}
